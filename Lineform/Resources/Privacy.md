...
- Text piped into the `lineform` command line tool is written to a local file — in `~/Library/Group Containers/group.TV4QZT7A7X.com.lineform/Lineform/Piped/` for released builds, or `~/Library/Application Support/Lineform/Piped/` otherwise — and opened as a normal document. These piped files stay on your device and are automatically deleted after about 7 days of inactivity.
