...
struct MarkdownReference {
    ...
    static func sections(in bundle: Bundle = .main) -> [Section] {
        ...
        Section(title: "Markdown Basics", rows: [
            ...
            Row(syntax: "Tab", explanation: "Inside a table, moves to the next cell. Shift-Tab goes back.", rendersSyntaxAsCode: false),
        ...
        Section(title: "Spelling", rows: [
            Row(syntax: "Spelling", explanation: "Misspellings underline as you type. Nothing is autocorrected.", rendersSyntaxAsCode: false),
            Row(syntax: "Skipped", explanation: "Code, math, front matter, and link addresses are never flagged.", rendersSyntaxAsCode: false),
        ]),
