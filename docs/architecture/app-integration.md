...
- Standard macOS About panel showing `V1.6.0` (`AppMenuConfiguration.aboutVersionDisplay`, asserted by `AppCommandNotificationTests`). This is a HAND-MAINTAINED literal, not derived from `MARKETING_VERSION` — it silently drifted and shipped as `V1.2.0` while the app was 1.3.0 (caught 2026-07-25). Bump it, and the test, in the same change as any version bump.
